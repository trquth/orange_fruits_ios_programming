...
class FooterTodoTableView : UITableViewHeaderFooterView{
    ...
    let addNewTodoButton : UIButton = {
     ...
     func setupView()  {
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-10-[v1(80)]-5-[v2(==v1)]", options: []  , metrics: nil, views: views))
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:[v3(50)]-10-|", options: []  , metrics: nil, views: views))
        
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[v1(50)]", options: [], metrics: nil, views: views))
